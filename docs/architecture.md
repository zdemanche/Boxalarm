...
3. Authorize device flow / Composio GitHub when next agent posts a fresh code
4. Locally: `gh api -H "Accept: application/vnd.github.raw" "repos/zdemanche/boxalarm-backend/contents/tmp-host/architecture-merged.md?ref=main" > docs/architecture.md && git add/commit/push`
